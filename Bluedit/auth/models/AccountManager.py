...
# Import required dependencies (own domain)
from Bluedit.auth.models.Account import Account

# Import required dependencies (shared)
...
class AccountManager(Generator, Sanitizer, Email, OTP):
    def __init__(self):
    ...
    def delete_account(self, id):
        result = self.gateway.delete_account(id)
